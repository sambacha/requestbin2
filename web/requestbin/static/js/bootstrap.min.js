...
!(function (e) {
  ...
  !(function (e) {
    ...
    t.prototype = {
      ...
      slide(t, n) {
        const r = this.$element.find(".item.active");
        let i = n || r[t]();
        const s = this.interval;
        const o = t == "next" ? "left" : "right";
        const u = t == "next" ? "first" : "last";
        const a = this;
        let f;
        (this.sliding = !0),
          s && this.pause(),
    ...
    (e.fn.carousel = function (n) {
      return this.each(function () {
        const r = e(this);
        let i = r.data("carousel");
        const s = e.extend(
          {},
          e.fn.carousel.defaults,
          typeof n === "object" && n
        );
        const o = typeof n === "string" ? n : s.slide;
      ...
      e(document).on(
        ...
        function (t) {
          ...
          const s = e.extend({}, i.data(), n.data());
          let o;
          i.carousel(s),
      ...
      e(document).on(
        ...
        function (t) {
          ...
          const i =
            ...
            t.preventDefault() ||
            ((r = n.attr("href")) && r.replace(/.*(?=#[^\s]+$)/, ""));
          const s = e(i).data("collapse") ? "toggle" : n.data();
    ...
    t.prototype = {
        ...
        (this.isShown = !0),
          ...
          this.backdrop(() => {
            ...
            t.$element.parent().length || t.$element.appendTo(document.body),
              ...
              t.enforceFocus(),
              n
                ? t.$element.one(e.support.transition.end, () => {
      ...
      escape() {
        ...
        this.isShown && this.options.keyboard
          ? this.$element.on("keyup.dismiss.modal", (t) => {
              t.which == 27 && e.hide();
            })
      ...
      backdrop(t) {
        const n = this;
        const r = this.$element.hasClass("fade") ? "fade" : "";
  ...
  !(function (e) {
    ...
    t.prototype = {
      ...
      enter(t) {
        const n = e.fn[this.type].defaults;
        const r = {};
        let i;
        this._options &&
          e.each(
  ...
  !(function (e) {
    function t(t, n) {
      ...
      const i = e(t).is("body") ? e(window) : e(t);
      let s;
    ...
    t.prototype = {
      ...
      refresh() {
        ...
        (this.offsets = e([])),
          ...
          (n = this.$body
            ...
            .map(function () {
              const n = e(this);
              const r = n.data("target") || n.attr("href");
              const i = /^#\w/.test(r) && e(r);
              return (
                (i &&
                  i.length && [
                    [
      ...
      process() {
        ...
        const n = t - this.$scrollElement.height();
  ...
  !(function (e) {
    ...
    t.prototype = {
      ...
      show() {
        const t = this.element;
        const n = t.closest("ul:not(.dropdown-menu)");
        let r = t.attr("data-target");
        let i;
        let s;
        let o;
  ...
  !(function (e) {
    ...
    t.prototype = {
      ...
      next(t) {
        const n = this.$menu.find(".active").removeClass("active");
        let r = n.next();
        r.length || (r = e(this.$menu.find("li")[0])), r.addClass("active");
      },
      prev(e) {
        const t = this.$menu.find(".active").removeClass("active");
        let n = t.prev();
  ...
  !(function (e) {
    ...
    t.prototype.checkPosition = function () {
      ...
      const t = e(document).height();
      const n = this.$window.scrollTop();
      const r = this.$element.offset();
      const i = this.options.offset;
      let s = i.bottom;
      let o = i.top;
      const u = "affix affix-top affix-bottom";
      let a;
