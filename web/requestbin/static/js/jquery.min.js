...
(function (e, t) {
  ...
  const q = function (e) {
    (a.addEventListener || e.type === "load" || a.readyState === "complete") &&
      (_(), x.ready());
  };
  var _ = function () {
    a.addEventListener
  ...
  (x.fn = x.prototype = {
    ...
    (x.ready.promise = function (t) {
      if (!n) {
        if (((n = x.Deferred()), a.readyState === "complete")) {
          setTimeout(x.ready);
  ...
  (r = x(a)),
    (function (e, t) {
      ...
      (r.sortStable = b.split("").sort(A).join("") === b),
        ...
        p(),
        (r.sortDetached = ut(
          (e) => 1 & e.compareDocumentPosition(f.createElement("div"))
        )),
        ut(
          (e) => (
          ...
          ct("type|href|height|width", (e, n, r) =>
            r ? t : e.getAttribute(n, n.toLowerCase() === "type" ? 1 : 2)
          ),
        (r.attributes &&
          ut(
            (e) => (
          ...
          ct("value", (e, n, r) =>
            r || e.nodeName.toLowerCase() !== "input" ? t : e.defaultValue
          ),
  ...
  (x.Callbacks = function (e) {
    ...
    (x.support = (function (t) {
      ...
      (s = a.createElement("select")),
        ...
        (t.html5Clone =
          a.createElement("nav").cloneNode(!0).outerHTML !== "<:nav></:nav>"),
      ...
      return (
        ...
        x(() => {
          ...
          l &&
            ...
            e.getComputedStyle &&
              ((t.pixelPosition =
                (e.getComputedStyle(d, null) || {}).top !== "1%"),
              (t.boxSizingReliable =
    ...
    if (x.acceptData(e)) {
      ...
      if ((c && u[c] && (i || u[c].data)) || r !== t || typeof n !== "string") {
        return (
          ...
          typeof n === "string"
            ? ((o = a[n]), o == null && (o = a[x.camelCase(n)]))
            : (o = a),
          o
        );
      }
    ...
    x.fn.extend({
      data(e, n) {
        ...
        if (e === t) {
          if (
            this.length &&
            ((o = x.data(s)), s.nodeType === 1 && !x._data(s, "parsedAttrs"))
          ) {
          ...
          r > arguments.length
            ...
            : this.each(function () {
                ...
                x._queueHooks(this, e),
                  e === "fx" && t[0] !== "inprogress" && x.dequeue(this, e);
              })
        );
      },
      dequeue(e) {
  ...
  x.fn.extend({
    ...
    is(e) {
      return !!ft(
        this,
        typeof e === "string" && ut.test(e) ? x(e) : e || [],
        !1
      ).length;
    },
    closest(e, t) {
      ...
      const o = [];
      const a =
        ut.test(e) || typeof e !== "string" ? x(e, t || this.context) : 0;
      for (; i > r; r++) {
  ...
  (At.optgroup = At.option),
    ...
    x.fn.extend({
      ...
      domManip(e, t, n) {
        ...
        if (
          g ||
          (!(c <= 1 || typeof h !== "string" || x.support.checkClone) &&
            Nt.test(h))
        ) {
  ...
  x.extend({
    clone(e, t, n) {
      ...
      if (
        ...
        for (r = Ft(o), s = Ft(e), a = 0; (i = s[a]) != null; ++a) {
          r[a] && Ot(i, r[a]);
        }
      }
      if (t) {
        if (n) {
          for (s = s || Ft(e), r = r || Ft(o), a = 0; (i = s[a]) != null; a++) {
            Mt(i, r[a]);
          }
        } else Mt(e, o);
      }
      ...
      ((x.expr.filters.hidden = function (e) {
        return (
          ...
          (!x.support.reliableHiddenOffsets &&
            ((e.style && e.style.display) || x.css(e, "display")) === "none")
        );
      }),
  ...
  (x.fn.load = function (e, n, r) {
    ...
    x.extend({
      ...
      ajax(e, n) {
        ...
        if (p.beforeSend && (p.beforeSend.call(f, C, p) === !1 || b === 2)) {
          return C.abort();
        }
        w = "abort";
  ...
  const Qn = {
    "*": [
      function (e, t) {
        ...
        let a =
          (x.cssNumber[e] || (o !== "px" && +r)) && Yn.exec(x.css(n.elem, e));
        let s = 1;
        let l = 20;
        if (a && a[3] !== o) {
          (o = o || a[3]), (i = i || []), (a = +r || 1);
  ...
  function er(e, t, n) {
    ...
    var l = function () {
      ...
      return (
        s.notifyWith(e, [u, o, n]), o < 1 && l ? n : (s.resolveWith(e, [u]), !1)
      );
    };
    var u = s.promise({
      elem: e,
  ...
  function nr(e, t, n) {
    ...
    for (r in t) {
      if (((i = t[r]), Vn.exec(i))) {
        if (
          (delete t[r], (o = o || i === "toggle"), i === (f ? "hide" : "show"))
        ) {
          continue;
        }
  ...
  x.each(
    ...
    (x.offset = {
      setOffset(e, t, n) {
        ...
        const l =
          (r === "absolute" || r === "fixed") && x.inArray("auto", [a, s]) > -1;
        const u = {};
        let c = {};
        let p;
        let f;
